...
VALUES (DEFAULT, 'Arjun Nagar', 'Unit 1', @GUR595, 8); 
SET @ARJUN1 = last_insert_id();

INSERT INTO schools ( school_id, school_name, school_no, address_id, base_fee)
VALUES (DEFAULT, 'Arjun Nagar', 'Unit 2', @GUR17, 8); 
SET @ASHOK2 = last_insert_id();

INSERT INTO schools ( school_id, school_name, school_no, address_id, base_fee)
VALUES (DEFAULT, 'Aya Nagar', 'Unit 3', @DEL185, 12 ); 
...
INSERT INTO students ( student_id, f_name, l_name, dob, registration_fee, parent_id, address_id) 
...
INSERT INTO Grade_level_has_Students (grade_level_id, students_id, start_date, end_date) VALUES
(@GUR17_K, @SINGH_04_13_17, '2020-09-01', '2021-05-30'),
