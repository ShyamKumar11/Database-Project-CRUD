...
CREATE TABLE IF NOT EXISTS `myschool`.`students_grade_levels` (
  ...
  `end_date` DATE NULL,
  PRIMARY KEY (`grade_level_id`, `student_id`),
  INDEX `fk_Grade_level_has_Students_Students1_idx` (`student_id` ASC) VISIBLE,
...
INSERT INTO schools ( school_id, school_name, school_no, address_id, base_fee)
VALUES (DEFAULT, 'Ashok Vihar', '2', @GUR17, 8); 
...
INSERT INTO students ( student_id, f_name, l_name, dob, registration_fee, parent_id) 
VALUES (DEFAULT, 'Selvi' , 'Manual', '2016-06-09', 3, @S_Manual);
...
INSERT INTO students_grade_levels (grade_level_id, student_id, start_date, end_date) VALUES
